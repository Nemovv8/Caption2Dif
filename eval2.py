...
def main(args):
    ...
    for i in range(len(filename)):
        ...
        print("BLEU-1 {} BLEU-2 {} BLEU-3 {} BLEU-4 {}  ROUGE_L {} CIDEr {}".format
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='checkpoints/3-times/')#./checkpoints/train_1_method_10/3-times/
